    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          description="Define clear objectives, organize necessary resources, and set deadlines to create a roadmap for success."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card title="Implementation" 
              ...
              description="Carry out the plan, adapt to challenges, and maintain open communication to ensure smooth progress."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card title="Review & Improve" 
              icon={<AceternityIcon order="Phase 3" />}
              description="Evaluate the outcome, gather feedback, and refine processes for continuous improvement."
        >
          <CanvasRevealEffect
            animationSpeed={3}
